...
import 'logger.dart';
import 'package:payment/google_sign_in_btn.dart';
import 'main_screen.dart';
import 'package:payment/masked_text.dart';
...
//      final GoogleSignInAuthentication googleAuth = await ;
      user.authentication.then((onv) async{
        Logger.log(TAG, message: "Added googleAuth: $onv");

        final result = await _auth
            .signInWithCredential(GoogleAuthProvider.getCredential(
          accessToken: onv.accessToken,
          idToken: onv.idToken,
        ))
            .catchError(onError);
